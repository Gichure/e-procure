	...
	public void should_save() {
	 ...
	 // @Test
	  ...
	  public void should_find_by_email() {
	    ...
	    List<Address> addresses = repository.findAllByEmail("gichurepaul@gmail.com");
	  ...
	  public void should_delete_address_by_id() {
	    ...
	    Address address3 = Address.builder()
	    		...
	    		.zipCode("001").build();
	    entityManager.persist(address3);
	    repository.deleteById(address2.getId());
	    List<Address> addresses = repository.findAll();
	    assertThat(addresses).hasSize(2).contains(address1, address3);
	  }
